    ...
    def writeResourcesConfig(self, filename="resources.cfg", scanner: ResourceScanner =None):
        ...
        with open(file, 'w') as resCfg:
            if scanner is None:
                ...
                resCfg.write(f"# GENERATED BY: https://github.com/Bluscream/FiveMResourceScanner{linesep}")
                categorized = OrderedDict(sorted(categorizeResources(scanner.resources).items()))
